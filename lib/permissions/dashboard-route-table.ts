...
export const ROUTE_RULES: readonly RouteRule[] = [
  ...
  { permission: "page:chat", href: "/dashboard/chat-operations", iconKey: "chat", prefixMatch: true },
  { permission: "page:chat", href: "/dashboard/chat-monitor", iconKey: "chat", prefixMatch: true },
  { permission: "page:chat", href: "/dashboard/chat-qa", iconKey: "chat", prefixMatch: true },
  {
...
const DASHBOARD_URL_SEGMENT_TO_PAGE: Readonly<Record<string, PagePermission>> = {
  ...
  "chat-monitor": "page:chat",
  "chat-qa": "page:chat",
  "chat-reports": "page:chat",
  "chat-widget": "page:chat-widget",
  "chat-settings": "page:chat-widget",
  "chat-involvement": "page:chat-widget",
