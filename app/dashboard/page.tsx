...
import { DashboardCard, Dropdown, SegmentedControl, DataTable, dataTableActionButton } from "@/components/common";
...
const RevenueLineChart = dynamic(
  ...
  { ssr: false, loading: () => <Box sx={{ minHeight: 220, display: "flex", alignItems: "center", justifyContent: "center" }} /> }
);

const ChatAnalyticsBarChart = dynamic(
  () => import("@/components/common/Charts").then((m) => ({ default: m.ChatAnalyticsBarChart })),
  { ssr: false, loading: () => <Box sx={{ minHeight: 260, display: "flex", alignItems: "center", justifyContent: "center" }} /> }
);

const DepartmentPieChart = dynamic(
  () => import("@/components/common/Charts").then((m) => ({ default: m.DepartmentPieChart })),
  { ssr: false, loading: () => <Box sx={{ minHeight: 280, display: "flex", alignItems: "center", justifyContent: "center" }} /> }
);
        ...
        render: (_, row) => {
          ...
          return (
            <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
              <Avatar
                src={hasImage ? userImage : userIconPath}
                sx={{
                  width: 32,
                  height: 32,
                  bgcolor: "#3B82F6",
              ...
              >
                {!hasImage && <PersonIcon sx={{ fontSize: 18 }} />}
              </Avatar>
          ...
          <Box sx={revenueHeaderRow}>
            <Box sx={revenueTitleRow}>
              <Box sx={revenueIconBox}>
                <AttachMoneyIcon sx={{ fontSize: 18, color: "#E5E7EB" }} />
              </Box>
