...
export type DeleteDepartmentConfirmModalProps = {
  open: boolean;
...
export function DeleteDepartmentConfirmModal({
  ...
  const name = departmentName.trim() || "this department";
        ...
        <Box sx={{ display: "flex", alignItems: "flex-start", gap: 2 }}>
          ...
          <Box sx={{ flex: 1, minWidth: 0 }}>
            ...
            >
              ...
              will be soft-deleted. This only succeeds when there are no active users in the department.
            </Typography>
            <Typography variant="small" sx={{ color: theme.app.dashboard.textMuted, lineHeight: 1.5 }}>
              You can cancel if you are unsure. This action may be audited in your organization.
            </Typography>
          </Box>
        </Box>
