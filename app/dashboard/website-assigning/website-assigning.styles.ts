...
export const departmentsPageWrapper: SxProps<Theme> = {
  maxWidth: 1600,
  mx: "auto",
};

export const departmentsHeader: SxProps<Theme> = {
  display: "flex",
...
export const departmentsAddButtonWrapper: SxProps<Theme> = {
  display: "flex",
  alignItems: "center",
...
export const departmentsAddButton: SxProps<Theme> = {
  borderRadius: "9999px",
  px: 3,
  py: 1.25,
  display: "inline-flex",
...
export const departmentsIconBox: SxProps<Theme> = {
  width: 40,
  height: 40,
  borderRadius: "12px",
...
export const departmentsFooterRow: SxProps<Theme> = {
  mt: 1,
  display: "flex",
  flexDirection: { xs: "column", sm: "row" },
  alignItems: { xs: "flex-start", sm: "center" },
...
export const departmentsPaginationWrapper: SxProps<Theme> = {
  width: { xs: "100%", sm: "auto" },
  display: "flex",
