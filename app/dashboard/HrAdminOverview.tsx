...
import { Typography, DashboardCard, Dropdown, FilterButton, Button, DataTable } from "@/components/common";
import type { DataTableColumn } from "@/components/common";
import { MetricCard } from "@/components/dashboard";
import { Person as PersonIcon, AttachMoney as AttachMoneyIcon, BarChart as BarChartIcon, Star as StarIcon, ChatBubble as ChatBubbleIcon, ArrowForward as ArrowForwardIcon, AccessTime as AccessTimeIcon } from "@mui/icons-material";
...
type AgentRow = { name: string; status: string; statusColor: string; activeChats: number; avgResponse: string };
      ...
      {Array.from({ length: total }).map((_, i) => (
        <Box
          ...
          sx={{
            ...
            height: 16,
            borderRadius: 1,
            bgcolor: i < count ? (count >= 3 ? theme.app.dashboard.accentGreen : theme.app.dashboard.accentOrange) : theme.app.dashboard.overlayMedium,
          }}
        />
      ))}
    </Box>
...
export default function HrAdminOverview() {
            ...
            <Box key={idx} sx={getLiveChatCard(theme)}>
              ...
              <Box sx={getLiveChatMessageBlock(theme)}>
                <Typography variant="caption" sx={getLiveChatMessageText(theme)}>
                  Can you help me upgrade my subscription plan to Pro? Can you help me upgrade my subscription plan to Pro? help me upgrade my subscription plan to Pro?
                </Typography>
              </Box>
