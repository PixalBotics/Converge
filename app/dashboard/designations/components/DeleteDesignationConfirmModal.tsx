...
export type DeleteDesignationConfirmModalProps = {
  open: boolean;
...
export function DeleteDesignationConfirmModal({
  open,
  designationName,
  onDismiss,
  onConfirm,
  isDeleting,
}: DeleteDesignationConfirmModalProps) {
  const theme = useTheme() as AppTheme;
  useBodyScrollLock(open);

  if (!open) return null;

  const name = designationName.trim() || "this designation";
        ...
        <Box sx={{ display: "flex", alignItems: "flex-start", gap: 2 }}>
          ...
          <Box sx={{ flex: 1, minWidth: 0 }}>
            ...
            >
              ...
              will be soft-deleted. This action may be audited in your organization.
            </Typography>
