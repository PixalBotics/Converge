...
export function EmptyAttendanceState({
  ...
  subtitle = "Try a different date range or clear filters to view data.",
}: {
  title?: string;
  subtitle?: string;
}) {
  ...
  return (
    ...
    >
      ...
      <Typography variant="small" sx={{ color: theme.app.dashboard.textMuted, textAlign: "center", maxWidth: 520 }}>
        {subtitle}
      </Typography>
    </Box>
  );
